  ...
  return (
    <div className="bg-background rounded-lg shadow-lg">
      ...
      {isLoading ? ( // Show spinner while loading
        <div className="loading custom-spinner"></div>
      ) : sortedPools.length > 0 ? ( // Show table if data is available
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead></TableHead>
              ...
              <TableHead
                className="cursor-pointer"
                onClick={() => handleSort("dailyReward")}>
                Pool Daily Reward
                {sortColumn === "dailyReward" && (
                  <span className="ml-2">
                    {sortDirection === "asc" ? "\u2191" : "\u2193"}
                  </span>
                )}
              ...
              <TableHead
                className="cursor-pointer"
                onClick={() => handleSort("liquidityBeforeDeposit")}>
                Liquidity Before Deposit
                {sortColumn === "liquidityBeforeDeposit" && (
                  <span className="ml-2">
                    {sortDirection === "asc" ? "\u2191" : "\u2193"}
                  </span>
                )}
              ...
              <TableHead
                className="cursor-pointer"
                onClick={() => handleSort("liquidityAfterDeposit")}>
                Liquidity After Deposit
                {sortColumn === "liquidityAfterDeposit" && (
                  <span className="ml-2">
                    {sortDirection === "asc" ? "\u2191" : "\u2193"}
                  </span>
                )}
              ...
              <TableHead
                className="cursor-pointer"
                onClick={() => handleSort("dailyRewardInUSD")}>
                Your Daily Profit
                {sortColumn === "dailyRewardInUSD" && (
                  <span className="ml-2">
                    {sortDirection === "asc" ? "\u2191" : "\u2193"}
                  </span>
                )}
              ...
              <TableHead
                className="cursor-pointer"
                onClick={() => handleSort("maxPossibleRewardInUSD")}>
                Your Max Possible Profit
                {sortColumn === "maxPossibleRewardInUSD" && (
                  <span className="ml-2">
                    {sortDirection === "asc" ? "\u2191" : "\u2193"}
                  </span>
                )}
              ...
              <TableRow key={index}>
                ...
                <TableCell style={styles.container}>
                  <img
                    src={dat.dexImgUrl}
                    style={styles.image}
                    title={dat.dexName}></img>
                  <a href={dat.url} style={styles.text}>
                    <u>{dat.name}</u>
                  </a>
                </TableCell>
